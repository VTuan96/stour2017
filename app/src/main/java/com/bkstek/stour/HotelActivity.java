...
public class HotelActivity extends AppCompatActivity {
    ...
    Context context;
    AdapterHotelSearch adapterHotel;
...
//        imBack = (ImageView) findViewById(R.id.imBack);
        ...
        context = HotelActivity.this;

        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(getApplicationContext(), 1);
        recyclerList.setLayoutManager(layoutManager);
        adapterHotel = new AdapterHotelSearch(context, historyList);
        ...
        svHotel = findViewById(R.id.svHotel);
        svHotel.setLayoutParams(new Toolbar.LayoutParams(Gravity.RIGHT));
        ...
        svHotel.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
                if (s.length() != 0) {
                    ...
                    adapterHotel = new AdapterHotelSearch(context, historyListTemp);
                    recyclerList.setAdapter(adapterHotel);
                    adapterHotel.notifyDataSetChanged();
                } else {
                    recyclerList.removeAllViews();
