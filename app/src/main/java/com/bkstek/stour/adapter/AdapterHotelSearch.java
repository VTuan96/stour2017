...
public class AdapterHotelSearch extends RecyclerView.Adapter<AdapterHotelSearch.ViewHolderHotel> {

    private Context context;
    private List<History> historyList;

    public AdapterHotelSearch(Context context, List<History> historyList) {
    ...
    public class ViewHolderHotel extends RecyclerView.ViewHolder {
        ...
        public ViewHolderHotel(View itemView) {
            ...
            imgHotel = (ImageView) itemView.findViewById(R.id.imHotelSearch);
            txtHotelName = (TextView) itemView.findViewById(R.id.txtHotelNameSearch);
            txtHotelAddress = itemView.findViewById(R.id.txtHotelAddressSearch);
            cvContainHotelSearch = itemView.findViewById(R.id.cvContainHotelSearch);
        }
    }
    ...
    public ViewHolderHotel onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.adapter_hotel_layout_search, parent, false);
